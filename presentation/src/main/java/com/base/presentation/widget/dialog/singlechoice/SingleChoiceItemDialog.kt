...
import com.base.presentation.databinding.DialogSingleChoiceItemBinding
                        ...
                        itemSelected?.key?.let {
                            runBlocking {
                                ...
                                pm.setComponentEnabledSetting(
                                    ComponentName(requireActivity(), "${BuildConfig.APPLICATION_ID}$launcherAlias"),
                                ...
                                pm.setComponentEnabledSetting(
                                    ComponentName(requireActivity(), "${BuildConfig.APPLICATION_ID}$it"),

package com.base.basemvvmcleanarchitecture.presentation.ui.filehide
...
import com.base.basemvvmcleanarchitecture.models.HideFileExt
import com.base.basemvvmcleanarchitecture.presentation.ui.filepreview.FilePreViewActivity
import com.base.basemvvmcleanarchitecture.service.FileService
import com.base.basemvvmcleanarchitecture.service.GroupFileService
...
class FileHideActivity : BaseHideActivity(), BaseHideAdapter.OnListener {
    ...
    override fun openHolder(groupID: Int) = runBlocking {
        val groupList = groupFileService.getGroupFiles(groupID) as List<GroupFile>

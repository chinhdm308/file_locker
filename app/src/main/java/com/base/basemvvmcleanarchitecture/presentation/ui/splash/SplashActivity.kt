package com.base.basemvvmcleanarchitecture.presentation.ui.splash
...
import com.base.basemvvmcleanarchitecture.presentation.ui.permission.PermissionActivity
    ...
    private suspend fun startActivity() {
        ...
        val intent = if (!isPermissionGranted) {
            ...
            if (dataStoreRepository.getAppFirstSettingInstanceDone()) {
                Intent(this, PatternCheckActivity::class.java)
            } else {

package com.chinchin.patternlockview;
...
import com.chinchin.patternlockview.utils.PatternLockUtils;
import com.chinchin.patternlockview.utils.ResourceUtils;
...
public class PatternLockView extends View {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        setPattern(PatternViewMode.CORRECT, PatternLockUtils.stringToPattern(this, savedState.getSerializedPattern()));
    ...
    public static class Dot implements Parcelable {
        ...
        public boolean equals(Object object) {
            if (object instanceof Dot) return mColumn == ((Dot) object).mColumn && mRow == ((Dot) object).mRow;

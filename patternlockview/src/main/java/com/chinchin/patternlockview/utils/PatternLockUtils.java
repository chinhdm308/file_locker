...
package com.chinchin.patternlockview.utils;
...
public class PatternLockUtils {
     ...
     */
    public static ArrayList<PatternLockView.Dot> generateRandomPattern(PatternLockView patternLockView, int size)
            ...
            for (int distance = 1; distance <= maxDistance; distance++) {
                ...
                for (int line : lines) {
                    switch (line) {
                        case 0: {
                            if (rowA >= 0) {
                                randomValues = RandomUtils.randIntArray(Math.max(0, colA), Math.min(patternLockView.getDotCount(), colC + 1));
                        ...
                        case 1: {
                            if (colC < patternLockView.getDotCount()) {
                                randomValues = RandomUtils.randIntArray(Math.max(0, rowA + 1), Math.min(patternLockView.getDotCount(), rowC + 1));
                        ...
                        case 2: {
                            if (rowC < patternLockView.getDotCount()) {
                                randomValues = RandomUtils.randIntArray(Math.max(0, colA), Math.min(patternLockView.getDotCount(), colC));
                                for (int c : randomValues) {
                        ...
                        case 3: {
                            if (colA >= 0) {
                                randomValues = RandomUtils.randIntArray(Math.max(0, rowA + 1), Math.min(patternLockView.getDotCount(), rowC));
                                for (int r : randomValues) {
